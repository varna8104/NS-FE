          ...
          <div className="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5">
            ...
            <div className="px-4 py-3 text-center">
              ...
              <div className="mt-4 flex gap-4 justify-center">
                <Link href="/register?zone=user" className={`text-sm px-3 py-1 rounded ${!isCopZone ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'}`}>
                  User Zone
                </Link>
                <Link href="/register?zone=cop" className={`text-sm px-3 py-1 rounded ${isCopZone ? 'bg-green-100 text-green-700' : 'text-gray-600 hover:bg-gray-100'}`}>
                  Cop Zone
                </Link>
              </div>
            </div>
